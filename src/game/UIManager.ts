...
export class UIManager {
    ...
    // Track transition elements for cleanup
    private transitionElements: any[] = [];
    ...
    public showLevelTransition(level: number, callback: () => void): void {
        ...
        // Main "LEVEL X" text - MASSIVE and bold
        ...
        // Decorative top line
        const lineTop = this.scene.add.rectangle(
            centerX,
            centerY - 100,
            0,
            6,
        ...
        const lineBottom = this.scene.add.rectangle(
            centerX,
            centerY + 100,
            0,
            6,
        ...
        // 3. Pop in the level text with dramatic scale
        this.scene.tweens.add({
            targets: levelText,
            alpha: 1,
            scale: 1,
        ...
        // 6. Hold, then fade out everything
        this.scene.time.delayedCall(2000, () => {
            ...
            // Fade and scale out main elements
            this.scene.tweens.add({
    ...
    /**
     * Cleans up all transition elements
     */
